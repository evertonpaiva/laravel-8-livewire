<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
        {{-- Menu Dinamico --}}
        @foreach(\App\Models\NavigationMenu::getSidebarMenuItens()->toArray() as $item)
            @can($item['permission'])
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="{{ route($item['slug'])}} ">
                    <i class="{{ $item['icon'] }}"></i>
